...
U12M_Gr30_60m = scenario.Task('U12M_Gr30_60m', length=1, delay_cost=1, state=1, plot_color='yellow')
U12M_Gr30_Pause_1 = scenario.Task('U12M_Gr30_Pause_1', length=3, delay_cost=5, state=-1, plot_color='white')
...
U12M_Gr31_60m = scenario.Task('U12M_Gr31_60m', length=3, delay_cost=1, state=1, plot_color='yellow')
...
U12M_Gr31_Kugel += Gr31
U12M_Gr31_Pause_3 += Gr31
U12M_Gr30_to_Gr34_600m += Gr31
