...
n = 20 # use only ten cities to test, more cities take a lone time #len(cities_table)
capacity = n/2.0+1 # each vehicle can visit half of the cities +1 to avoid rounding problems
...
# add some time windows: half the cities before time step 20
...
solver.solve(S,kind='CPLEX',msg=1,lp_filename=None)
