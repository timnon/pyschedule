...
class AthleticsEventScheduler(object):
    ...
    def solve(self, time_limit, ratio_gap, random_seed):
        logging.debug('solving problem...')
        status = solvers.mip.solve(self._scenario, time_limit=time_limit, ratio_gap=ratio_gap, random_seed=random_seed, msg=1)
