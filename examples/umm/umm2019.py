    ...
    'saturday': {
        ...
        "U16W_5K": {
            "disziplinen": [
                ...
                dict(name="Kugel", together=False, resource="Kugel", length=2),
                dict(name="Pause_3", together=False, resource=None, length=1),
                dict(name="Hoch", together=False, resource="Hoch", length=4),
                dict(name="Pause_4", together=False, resource=None, length=1),
                dict(name="600m", together=True, resource="Läufe", length=3),
            ],
            "plot_color": "pink",
        },
        "WOM_7K": {
            "disziplinen": [
                ...
                dict(name="Pause_1", together=False, resource=None, length=3),
                dict(name="Hoch", together=False, resource="Hoch", length=4),
        ...
        "MAN_10K": {
            "disziplinen": [
                ...
                dict(name="Pause_1", together=False, resource=None, length=5),
                dict(name="Weit", together=False, resource="Weit1&Weit2", length=3),
                dict(name="Pause_2", together=False, resource=None, length=3),
                dict(name="Kugel", together=False, resource="Kugel1&Kugel2", length=2),
                dict(name="Pause_3", together=False, resource=None, length=4),
                dict(name="Hoch", together=False, resource="Hoch1&Hoch2", length=4),
    ...
    "sunday": {
        "U14M_5K": {
            "disziplinen": [
                ...
                dict(name="Kugel", together=False, resource="Kugel", length=2),
                dict(name="Pause_3", together=False, resource=None, length=1),
                dict(name="Hoch", together=False, resource="Hoch", length=3),
                dict(name="Pause_4", together=False, resource=None, length=1),
                dict(name="600m", together=True, resource="Läufe", length=3),
            ],
            "plot_color": "orange",
        ...
        "MAN_6K": {
            "disziplinen": [
                ...
                dict(name="Hoch", together=False, resource="Hoch", length=3),
                dict(name="Pause_4", together=False, resource=None, length=1),
                dict(name="Speer", together=False, resource="Speer", length=3),
                dict(name="Pause_5", together=False, resource=None, length=1),
        ...
        "MAN_10K": {
            "disziplinen": [
                ...
                dict(name="Pause_1", together=False, resource=None, length=3),
                dict(name="Diskus", together=False, resource="Diskus", length=2),
                dict(name="Pause_2", together=False, resource=None, length=4),
                dict(name="Stab", together=False, resource="Stab", length=11),
                dict(name="Pause_3", together=False, resource=None, length=3),
                dict(name="Speer", together=False, resource="Speer", length=3),
                dict(name="Pause_4", together=False, resource=None, length=3),
