...
disziplinen_data = {
    'saturday': {
        "U12W_4K": [
            dict(name="60m", together=True, resource="Läufe", sequence_free=False, kwargs=dict(length=3, plot_color="orange")),
            dict(name="Pause_1", together=False, resource=None, sequence_free=False, kwargs=dict(length=1, plot_color='white')),
            dict(name="Weit", together=False, resource="Weit", sequence_free=True, kwargs=dict(length=3, plot_color="orange")),
            dict(name="Pause_2", together=False, resource=None, sequence_free=False, kwargs=dict(length=1, plot_color='white')),
            dict(name="Kugel", together=False, resource="Kugel", sequence_free=True, kwargs=dict(length=2, plot_color="orange")),
            dict(name="Pause_3", together=False, resource=None, sequence_free=False, kwargs=dict(length=1, plot_color='white')),
            dict(name="600m", together=True, resource="Läufe", sequence_free=False, kwargs=dict(length=3, plot_color="orange")),
        ],
        "U16W_5K": [
            dict(name="80m", together=True, resource="Läufe", sequence_free=False, kwargs=dict(length=3, plot_color="pink")),
            dict(name="Pause_1", together=False, resource=None, sequence_free=False, kwargs=dict(length=1, plot_color='white')),
            dict(name="Weit", together=False, resource="Weit", sequence_free=False, kwargs=dict(length=3, plot_color="pink")),
            dict(name="Pause_2", together=False, resource=None, sequence_free=False, kwargs=dict(length=1, plot_color='white')),
            dict(name="Kugel", together=False, resource="Kugel", sequence_free=False, kwargs=dict(length=2, plot_color="pink")),
            dict(name="Pause_3", together=False, resource=None, sequence_free=False, kwargs=dict(length=1, plot_color='white')),
            dict(name="Hoch", together=False, resource="Hoch", sequence_free=False, kwargs=dict(length=4, plot_color="pink")),
            dict(name="Pause_4", together=False, resource=None, sequence_free=False, kwargs=dict(length=1, plot_color='white')),
            dict(name="600m", together=True, resource="Läufe", sequence_free=False, kwargs=dict(length=3, plot_color="pink")),
        ],
        "WOM_7K": [
            dict(name="100mHü", together=True, resource="Läufe", sequence_free=False, kwargs=dict(length=3, plot_color="lightgreen")),
            dict(name="Pause_1", together=False, resource=None, sequence_free=False, kwargs=dict(length=3, plot_color='white')),
            dict(name="Hoch", together=False, resource="Hoch", sequence_free=False, kwargs=dict(length=4, plot_color="lightgreen")),
            dict(name="Pause_2", together=False, resource=None, sequence_free=False, kwargs=dict(length=3, plot_color='white')),
            dict(name="Kugel", together=False, resource="Kugel", sequence_free=False, kwargs=dict(length=2, plot_color="lightgreen")),
            dict(name="Pause_3", together=False, resource=None, sequence_free=False, kwargs=dict(length=3, plot_color='white')),
            dict(name="200m", together=True, resource="Läufe", sequence_free=False, kwargs=dict(length=2, plot_color="lightgreen")),
        ],
        "U12M_4K": [
            dict(name="60m", together=True, resource="Läufe", sequence_free=False, kwargs=dict(length=3, plot_color="yellow")),
            dict(name="Pause_1", together=False, resource=None, sequence_free=False, kwargs=dict(length=1, plot_color='white')),
            dict(name="Weit", together=False, resource="Weit", sequence_free=True, kwargs=dict(length=3, plot_color="yellow")),
            dict(name="Pause_2", together=False, resource=None, sequence_free=False, kwargs=dict(length=1, plot_color='white')),
            dict(name="Kugel", together=False, resource="Kugel", sequence_free=True, kwargs=dict(length=2, plot_color="yellow")),
            dict(name="Pause_3", together=False, resource=None, sequence_free=False, kwargs=dict(length=1, plot_color='white')),
            dict(name="600m", together=True, resource="Läufe", sequence_free=False, kwargs=dict(length=3, plot_color="yellow")),
        ],
        "U16M_6K": [
            dict(name="100mHü", together=True, resource="Läufe", sequence_free=False, kwargs=dict(length=2, plot_color="lightblue")),
            dict(name="Pause_1", together=False, resource=None, sequence_free=False, kwargs=dict(length=3, plot_color='white')),
            dict(name="Weit", together=False, resource="Weit", sequence_free=False, kwargs=dict(length=3, plot_color="lightblue")),
            dict(name="Pause_2", together=False, resource=None, sequence_free=False, kwargs=dict(length=3, plot_color='white')),
            dict(name="Kugel", together=False, resource="Kugel", sequence_free=False, kwargs=dict(length=2, plot_color="lightblue")),
            dict(name="Pause_3", together=False, resource=None, sequence_free=False, kwargs=dict(length=3, plot_color='white')),
            dict(name="Hoch", together=False, resource="Hoch", sequence_free=False, kwargs=dict(length=4, plot_color="lightblue")),
            dict(name="Pause_4", together=False, resource=None, sequence_free=False, kwargs=dict(length=3, plot_color='white')),
            dict(name="Diskus", together=True, resource="Diskus", sequence_free=False, kwargs=dict(length=5, plot_color="lightblue")),
            dict(name="Pause_5", together=False, resource=None, sequence_free=False, kwargs=dict(length=3, plot_color='white')),
            dict(name="1000m", together=True, resource="Läufe", sequence_free=False, kwargs=dict(length=2, plot_color="lightblue")),
        ],
        "MAN_10K": [
            dict(name="100m", together=True, resource="Läufe", sequence_free=False, kwargs=dict(length=1, plot_color="red")),
            dict(name="Pause_1", together=False, resource=None, sequence_free=False, kwargs=dict(length=5, plot_color='white')),
            dict(name="Weit", together=False, resource="Weit1&Weit2", sequence_free=False, kwargs=dict(length=3, plot_color="red")),
            dict(name="Pause_2", together=False, resource=None, sequence_free=False, kwargs=dict(length=3, plot_color='white')),
            dict(name="Kugel", together=False, resource="Kugel1&Kugel2", sequence_free=False, kwargs=dict(length=2, plot_color="red")),
            dict(name="Pause_3", together=False, resource=None, sequence_free=False, kwargs=dict(length=4, plot_color='white')),
            dict(name="Hoch", together=False, resource="Hoch1&Hoch2", sequence_free=False, kwargs=dict(length=4, plot_color="red")),
            dict(name="Pause_4", together=False, resource=None, sequence_free=False, kwargs=dict(length=4, plot_color='white')),
            dict(name="400m", together=True, resource="Läufe", sequence_free=False, kwargs=dict(length=2, plot_color="red")),
        ],
    },
    "sunday": {
        "U14M_5K": [
