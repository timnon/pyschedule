...
wettkampf_data = {
    'saturday': {
        "U12W_4K": {
            "disziplinen": [
                dict(name="60m", together=True, resource="Läufe", kwargs=dict(length=3)),
                dict(name="Pause_1", together=False, resource=None, kwargs=dict(length=1)),
                dict(name="Weit", together=False, resource="Weit", kwargs=dict(length=3)),
                dict(name="Pause_2", together=False, resource=None, kwargs=dict(length=1)),
                dict(name="Kugel", together=False, resource="Kugel", kwargs=dict(length=2)),
                dict(name="Pause_3", together=False, resource=None, kwargs=dict(length=1)),
                dict(name="600m", together=True, resource="Läufe", kwargs=dict(length=3)),
            ],
            "plot_color": "orange",
        },
        "U16W_5K": {
            "disziplinen": [
                dict(name="80m", together=True, resource="Läufe", kwargs=dict(length=3)),
                dict(name="Pause_1", together=False, resource=None, kwargs=dict(length=1)),
                dict(name="Weit", together=False, resource="Weit", kwargs=dict(length=3)),
                dict(name="Pause_2", together=False, resource=None, kwargs=dict(length=1)),
                dict(name="Kugel", together=False, resource="Kugel", kwargs=dict(length=2)),
                dict(name="Pause_3", together=False, resource=None, kwargs=dict(length=1)),
                dict(name="Hoch", together=False, resource="Hoch", kwargs=dict(length=4)),
                dict(name="Pause_4", together=False, resource=None, kwargs=dict(length=1)),
                dict(name="600m", together=True, resource="Läufe", kwargs=dict(length=3)),
            ],
            "plot_color": "pink",
        },
        "WOM_7K": {
            "disziplinen": [
                dict(name="100mHü", together=True, resource="Läufe", kwargs=dict(length=3)),
                dict(name="Pause_1", together=False, resource=None, kwargs=dict(length=3)),
                dict(name="Hoch", together=False, resource="Hoch", kwargs=dict(length=4)),
                dict(name="Pause_2", together=False, resource=None, kwargs=dict(length=3)),
                dict(name="Kugel", together=False, resource="Kugel", kwargs=dict(length=2)),
                dict(name="Pause_3", together=False, resource=None, kwargs=dict(length=3)),
                dict(name="200m", together=True, resource="Läufe", kwargs=dict(length=2)),
            ],
        ...
        "U16M_6K": {
            "disziplinen": [
                dict(name="100mHü", together=True, resource="Läufe", kwargs=dict(length=2)),
                dict(name="Pause_1", together=False, resource=None, kwargs=dict(length=3)),
                dict(name="Weit", together=False, resource="Weit", kwargs=dict(length=3)),
                dict(name="Pause_2", together=False, resource=None, kwargs=dict(length=3)),
                dict(name="Kugel", together=False, resource="Kugel", kwargs=dict(length=2)),
                dict(name="Pause_3", together=False, resource=None, kwargs=dict(length=3)),
                dict(name="Hoch", together=False, resource="Hoch", kwargs=dict(length=4)),
                dict(name="Pause_4", together=False, resource=None, kwargs=dict(length=3)),
                dict(name="Diskus", together=True, resource="Diskus", kwargs=dict(length=5)),
                dict(name="Pause_5", together=False, resource=None, kwargs=dict(length=3)),
                dict(name="1000m", together=True, resource="Läufe", kwargs=dict(length=2)),
            ],
            "plot_color": "lightblue",
        },
        "MAN_10K": {
            "disziplinen": [
                dict(name="100m", together=True, resource="Läufe", kwargs=dict(length=1)),
                dict(name="Pause_1", together=False, resource=None, kwargs=dict(length=5)),
                dict(name="Weit", together=False, resource="Weit1&Weit2", kwargs=dict(length=3)),
                dict(name="Pause_2", together=False, resource=None, kwargs=dict(length=3)),
                dict(name="Kugel", together=False, resource="Kugel1&Kugel2", kwargs=dict(length=2)),
                dict(name="Pause_3", together=False, resource=None, kwargs=dict(length=4)),
                dict(name="Hoch", together=False, resource="Hoch1&Hoch2", kwargs=dict(length=4)),
                dict(name="Pause_4", together=False, resource=None, kwargs=dict(length=4)),
                dict(name="400m", together=True, resource="Läufe", kwargs=dict(length=2)),
            ],
            "plot_color": "red",
        },
    },
    "sunday": {
        "U14M_5K": {
            "disziplinen": [
                ...
                dict(name="Kugel", together=False, resource="Kugel", kwargs=dict(length=2)),
                dict(name="Pause_3", together=False, resource=None, kwargs=dict(length=1)),
                dict(name="Hoch", together=False, resource="Hoch", kwargs=dict(length=3)),
                dict(name="Pause_4", together=False, resource=None, kwargs=dict(length=1)),
                dict(name="600m", together=True, resource="Läufe", kwargs=dict(length=3)),
            ],
            "plot_color": "orange",
        ...
        "MAN_6K": {
            "disziplinen": [
                dict(name="100m", together=True, resource="Läufe", kwargs=dict(length=3)),
                dict(name="Pause_1", together=False, resource=None, kwargs=dict(length=1)),
                dict(name="Weit", together=False, resource="Weit", kwargs=dict(length=3)),
                dict(name="Pause_2", together=False, resource=None, kwargs=dict(length=1)),
                dict(name="Kugel", together=False, resource="Kugel1&Kugel2", kwargs=dict(length=2)),
                ...
                dict(name="Hoch", together=False, resource="Hoch", kwargs=dict(length=3)),
                dict(name="Pause_4", together=False, resource=None, kwargs=dict(length=1)),
                dict(name="Speer", together=False, resource="Speer", kwargs=dict(length=3)),
                dict(name="Pause_5", together=False, resource=None, kwargs=dict(length=1)),
                dict(name="1000m", together=True, resource="Läufe", kwargs=dict(length=3)),
            ],
            "plot_color": "lightblue",
        },
        "WOM_5K": {
            "disziplinen": [
                dict(name="100m", together=True, resource="Läufe", kwargs=dict(length=2)),
                dict(name="Pause_1", together=False, resource=None, kwargs=dict(length=3)),
                dict(name="Weit", together=False, resource="Weit", kwargs=dict(length=3)),
                dict(name="Pause_2", together=False, resource=None, kwargs=dict(length=3)),
                dict(name="Kugel", together=False, resource="Kugel", kwargs=dict(length=2)),
        ...
        "MAN_10K": {
            "disziplinen": [
                dict(name="110mHü", together=True, resource="Läufe", kwargs=dict(length=3)),
                dict(name="Pause_1", together=False, resource=None, kwargs=dict(length=3)),
                dict(name="Diskus", together=False, resource="Diskus", kwargs=dict(length=2)),
                dict(name="Pause_2", together=False, resource=None, kwargs=dict(length=4)),
                dict(name="Stab", together=False, resource="Stab", kwargs=dict(length=11)),
                dict(name="Pause_3", together=False, resource=None, kwargs=dict(length=3)),
                dict(name="Speer", together=False, resource="Speer", kwargs=dict(length=3)),
                dict(name="Pause_4", together=False, resource=None, kwargs=dict(length=3)),
                dict(name="1500m", together=True, resource="Läufe", kwargs=dict(length=1)),
            ],
            "plot_color": "red",
        },
        "U14W_5K": {
            "disziplinen": [
                dict(name="60m", together=True, resource="Läufe", kwargs=dict(length=3)),  # FIXME: actual length should be 5
                dict(name="Pause_1", together=False, resource=None, kwargs=dict(length=1)),
                dict(name="Weit", together=False, resource="Weit", kwargs=dict(length=3)),
                dict(name="Pause_2", together=False, resource=None, kwargs=dict(length=1)),
                dict(name="Kugel", together=False, resource="Kugel", kwargs=dict(length=2)),
        ...
        "WOM_7K": {
            "disziplinen": [
                dict(name="Weit", together=True, resource="Weit1&Weit2", kwargs=dict(length=3)),
                dict(name="Pause_1", together=False, resource=None, kwargs=dict(length=3)),
                dict(name="Speer", together=True, resource="Speer", kwargs=dict(length=6)),
                dict(name="Pause_2", together=False, resource=None, kwargs=dict(length=3)),
                dict(name="800m", together=True, resource="Läufe", kwargs=dict(length=2)),
            ],
            "plot_color": "lightgreen",
        },
    }
